    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link active" href="/datas/datasiswa">
            ...
            <div id="content">
                        ...
                        <div class="topbar-divider d-none d-sm-block"></div>
                         ...
                         <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/profil/profilesekolah">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="/profil/editsandi">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">Kata Sandi Saat Ini</label><br>
                        <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Sandi Saat Ini">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">Kata Sandi Baru</label>
                        <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Sandi Baru">
                    </div>
                    
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">Konfirmasi Kata Sandi</label>
                        <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Sandi Baru Lagi">
                    </div>
                    ...
                    <div class="form-group">
                        <left>
                        <button type="submit" name="Submit" class="btn btn-primary waves">Konfirmasi</button>
                        </left>
                     </div>
                  </form>
