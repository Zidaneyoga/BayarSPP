        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
            ...
            <li class="nav-item active">
                <a class="nav-link active" href="/history/filterhistory">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 mr-3">
                                            <div class="input-group">
                                                <input type="search" class="form-control" autofocus name="r" placeholder="Cari Siswa Berdasarkan NISN" required>
                                                <div class="input-group-append">
                                                    <a href="/history/historypembayaran1" class="btn btn-primary" type="button">
                                                        <i class="fas fa-search fa-sm"></i>
                                                    </a>
                                                </div>
                                            </div>
