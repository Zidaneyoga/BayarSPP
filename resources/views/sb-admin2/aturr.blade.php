                        ...
                        <div class="row">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Karakter yang dimasukkan minimal 8 karakter atau lebih.</p>
                                    </div>
                                    <form class="user">
                                    ...
                                    <form class="user">
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-user"
                                                    id="exampleInputEmail" aria-describedby="emailHelp"
                                                    placeholder="Masukkan Sandi Baru Sekali Lagi">
                                        </div>
                                        <a href="/loginn" class="btn btn-primary btn-user btn-block">
                                            Konfirmasi
                                        </a>
                                    </form>
                                    <hr>
