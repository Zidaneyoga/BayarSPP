                    ...
                    <div class="col-xl-8 col-lg-10 col-md-9">
                          ...
                          <div class="container-fluid">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="number" name="nisn" class="form-control" placeholder="Masukkan NISN Siswa" id="exampleInputEmail1" aria-describedby="emailHelp" value="">
                              </div>
                              <div class="form-group">
                                    <label for="name">Nama</label>
                                    <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Siswa" id="exampleInputEmail1" aria-describedby="emailHelp" value="">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" name="alamat" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Alamat Siswa" aria-describedby="emailHelp" value="">
                              </div>
                              @csrf
                             
                              <a href="/datasiswa" class="btn btn-danger">Kembali</a>
