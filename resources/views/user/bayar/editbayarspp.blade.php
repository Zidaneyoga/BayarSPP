                    ...
                    <div class="col-xl-8 col-lg-10 col-md-9">
                          ...
                          <div class="container-fluid">
                              ...
                              <div class="card shadow mb-4">
                                  ...
                                  <form action="/updatebayarspp/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="date" name="tanggal"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pilih Tanggal Pembayaran"  value="{{ $data->tanggal }}">
                                    </div>

                                    <div class="form-group">
                                      <label>Nominal Pembayaran</label>
                                      <select class="form-control" name="nominal">
                                        <option selected>{{ $data->nominal }}</option>
