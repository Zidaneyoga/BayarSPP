        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="Ovo"><img src="img/Logo OVO.png" class="main-logo" width="120" />
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="Gopay"><img src="img/gopay.png" class="main-logo" width="180" />
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="Dana"><img src="img/dana.png" class="main-logo" width="120" />
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="Shopee"><img src="img/shopee.png" class="main-logo" width="180" />
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="Visa"><img src="img/visa.png" class="main-logo" width="180" />
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            <div class="input-group-text">
                              <input class="form-check-input mt-0" type="radio" value="atm"><img src="img/atm.png" class="main-logo" width="140" />
                            </div>
                        </div>
                        </label>
                    </div> 
                    ...
                    <div class="form-group">
                        <left>
                            <a href="/tables" class="btn btn-success btn-icon-split">
