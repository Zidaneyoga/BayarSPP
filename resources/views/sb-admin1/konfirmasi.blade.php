    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <center><div class="col-lg-7 mt-5">

                    <!-- Illustrations -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">PEMBAYARAN BERHASIL</h5>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 15rem;"
                                    src="img/undraw_confirmed_re_sef7.svg" alt="...">
                            </div>
                            <div class="col-md- mt-4">
                                <table class="table table-hover">
                                    <tbody>
                                        <tr>
                                          <h4><b>Selamat pembayaran SPP anda telah berhasil.</b></h4>
                                          <h6><i>Silahkan lihat/unduh bukti pembayaran</i></h6>
                                            <h6><i>yang ada dibawah! Terimakasih.</i></h6>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                <div class="form-group">
                    <right>
                     ...
                     <a href="/invoice" class="btn btn-danger btn-icon-split">
