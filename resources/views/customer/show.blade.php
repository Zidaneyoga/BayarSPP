									...
									<table class="table table-hover">
										<tbody>
											...
											<tr>
												<td>Nama</td>
												<td>:</td>
                        <td>{{ old('customer_name', $customer->customer_name) }}</td>
											</tr>

                      <tr>
												<td>Kelas</td>
												<td>:</td>
												<td>{{ old('contact_name', $customer->contact_name) }}</td>
											</tr>
											
											<tr>
												<td>Jurusan</td>
												<td>:</td>
												<td>{{ old('city', $customer->city) }}</td>
											</tr>

											<tr>
												<td>Alamat</td>
												<td>:</td>
												<td>{{ old('address', $customer->address) }}</td>
											</tr>
									    </tbody>
									</table>
								</div>
                        ...
                        <left>
                         ...
                         <a href="{{ route('customer.index') }}" class="btn btn-success btn-icon-split">
